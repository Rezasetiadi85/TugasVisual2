object Form8: TForm8
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lblI_l2: TLabel
    Left = 52
    Top = 120
    Width = 3
    Height = 13
  end
  object lblI_l1: TLabel
    Left = 4
    Top = 12
    Width = 114
    Height = 15
  ...
  object dbgrdSiswadbgrd1: TDBGrid
    Left = 8
    Top = 270
    Width = 968
    Height = 157
    ...
    TitleFont.Style = []
    OnCellClick = dbgrdSiswadbgrd1CellClick
    Columns = <
      item
        Expanded = False
        FieldName = 'Id_orgtua'
